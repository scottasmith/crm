...
final class Version20220519220224 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_detail (user_id CHAR(36) NOT NULL COMMENT \'(DC2Type:uuid)\', title VARCHAR(255) NOT NULL, given_name VARCHAR(255) NOT NULL, surname VARCHAR(255) NOT NULL, position VARCHAR(255) NOT NULL, home_tel VARCHAR(255) DEFAULT NULL, mobile_tel VARCHAR(255) DEFAULT NULL, work_tel VARCHAR(255) DEFAULT NULL, other_tel LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:simple_array)\', PRIMARY KEY(user_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
